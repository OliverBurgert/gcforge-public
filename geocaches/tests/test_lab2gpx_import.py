...
from geocaches.services.save_alc import save_alc_stage as _save_alc_stage
from geocaches.lc_code import uuid_to_lc_code
from geocaches.models import ALStageDetail, Adventure, CacheType, Geocache, Tag
...
class FormatAImportTest(TestCase):
    ...
    def test_two_stages_created(self):
        stage_codes = set(
            Geocache.objects.filter(al_detail__isnull=False)
    ...
    def test_stage1_question_text(self):
        ...
        self.assertEqual(
            stage1.al_detail.question_text,
    ...
    def test_stage2_question_text(self):
        ...
        self.assertEqual(
            stage2.al_detail.question_text,
...
class SaveAlcStageUUIDLookupTest(TestCase):
    ...
    def test_uuid_lookup_finds_existing(self):
        ...
        ALStageDetail.objects.create(geocache=gc, stage_number=1, al_stage_uuid="uuid-aaa")
        stats = ImportStats()
        _save_alc_stage(
            "LC1234-1",
    ...
    def test_uuid_lookup_updates_al_code(self):
        ...
        ALStageDetail.objects.create(geocache=gc, stage_number=1, al_stage_uuid="uuid-bbb")
        stats = ImportStats()
        _save_alc_stage(
            "LC5678-1",
        ...
        detail = ALStageDetail.objects.get(al_stage_uuid="uuid-bbb")
        self.assertEqual(detail.geocache.al_code, "LC5678-1")
