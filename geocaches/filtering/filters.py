...
(:mod:`geocaches.filtering.filter_expr`), compiled to Django ``Q`` objects by
...
from geocaches.geo import dist_to_segment_km, haversine_km, point_in_polygon
from geocaches.models import EVENT_CACHE_TYPES, FOUND_LOG_TYPES
...
def apply_alc_in_progress_filter(qs):
    ...
    from geocaches.models import Adventure, Geocache as _Geocache
