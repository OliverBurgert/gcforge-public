...
class BulkLogResult:
    ...
    tb_results: list = None

    def __post_init__(self):
        if self.tb_results is None:
            self.tb_results = []
...
def submit_field_note(
    ...
    *,
    ...
    if errors and hard_failure:
        ...
        return BulkLogResult(success=False, submit_error=submit_error, tb_results=result.tb_results)
