            ...
            if gc_client.has_api_tokens():
                try:
                    ...
                    card["data"] = {
                        ...
                        "find_count": profile["find_count"],
                        "hide_count": profile["hide_count"],
                        "favorite_points": profile["favorite_points"],
                        "membership": level_names.get(level, f"Level {level}"),
                        "avatar_url": profile["avatar_url"],
                        "join_date": profile["joined_date"],
                    ...
                    try:
                        ...
                        tbs = get_trackable_api_client().get_my_inventory()
