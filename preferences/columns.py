...
AVAILABLE_COLUMNS = [
    ...
    {"key": "adventure_type",       "label": "Adv. Type",  "sort": "adventure__adventure_type"},
    {"key": "challenge_type",       "label": "Challenge",  "sort": None},
    {"key": "answer_is_correct",    "label": "Ans.",       "sort": None},
    {"key": "alc_rating",           "label": "Rating",     "sort": "adventure__ratings_average"},
    {"key": "alc_highly_recommended", "label": "⭐",       "sort": "adventure__is_highly_recommended"},
]
...
BUILTIN_PRESETS = {
    ...
    "ALC": [
        "gc_code", "name", "cache_type", "adventure_type", "challenge_type",
        "answer_is_correct", "alc_rating", "alc_highly_recommended",
        "owner", "found_date", "distance", "tags", "flags",
    ],
